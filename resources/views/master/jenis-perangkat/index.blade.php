                    ...
                    <tr>
                        ...
                        <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-xs sm:text-sm text-gray-500">
                            <div class="flex flex-col sm:flex-row sm:space-x-2 space-y-2 sm:space-y-0">
                                ...
                                <form action="{{ route('master.jenis-perangkat.destroy', $jenisPerangkat->id_jenis_perangkat) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" 
                                            onclick="return confirm('Yakin ingin menghapus jenis perangkat ini?')"
